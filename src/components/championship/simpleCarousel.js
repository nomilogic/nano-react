              ...
              <View style={{flexDirection: 'column',marginLeft:10}}>
                ...
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  <Image
                    ...
                    source={{uri: 'https://media.nanodot.us/icon/Options.png'}}
                  />
                  <Text style={{color: '#7B7B7B', fontSize: 12,textAlignVertical:'center'}}>0/2500 completed</Text>
                </View>
              </View>
            </View>
